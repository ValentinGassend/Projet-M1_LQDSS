...
class ESP32Controller:
    ...
    def process_websocket_message(self, message):
        ...
        if "led_maze#on" in message:
            ...
            print("Démarrage de l'animation 'crystal_to_maze'")
            ...
            print("Démarrage de l'animation 'maze_start'")
            ...
            self.set_color(self.ZONE_GLOBAL, *self.COLORS["purple"])
            self.send_message("mbianceManager=>[ambianceManager]=>maze_rfid#end")
        elif message == "maze_finished#true":
            print("Démarrage de l'animation 'maze_finished'")
            ...
            print("Démarrage de l'animation 'maze_to_crystal'")
