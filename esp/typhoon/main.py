...
class ESP32Controller:
    ...
    def process_websocket_message(self, message):
        ...
        if "led_typhoon#on" in message:
            ...
            print("Démarrage de l'animation 'crystal_to_typhoon'")
            ...
            print("Démarrage de l'animation 'typhoon_start'")
            ...
            self.set_color(self.ZONE_GLOBAL, *self.COLORS["purple"])
            self.send_message("mbianceManager=>[ambianceManager]=>typhoon_rfid#end")
        elif message == "typhoon_finished#true":
            print("Démarrage de l'animation 'typhoon_finished'")
            self.send_message("ambianceManager=>[ambianceManager]=>typhoon_finished#start")
            self.color_transition_pulse(self.ZONE_TABLE,self.COLORS["purple"],self.COLORS["blue"],2,step=35)
            self.set_color(self.ZONE_TABLE, *self.COLORS["blue"])
            self.send_message("ambianceManager=>[ambianceManager]=>typhoon_finished#end")
        elif message == "typhoon_to_crystal#true":
            print("Démarrage de l'animation 'typhoon_to_crystal'")
            self.send_message("ambianceManager=>[ambianceManager]=>typhoon_to_crystal#start")
            self.fill_animation(self.ZONE_GROUND, *self.COLORS["blue"], delay_ms=5, direction="end")
            self.set_color(self.ZONE_GLOBAL, *self.COLORS["blue"])
            self.send_message("ambianceManager=>[ambianceManager]=>typhoon_to_crystal#end")
        else:
            print("message inconnus :" , message)
