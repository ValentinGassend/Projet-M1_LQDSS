...
class ESP32Controller:
    ...
    def process_websocket_message(self, message):
        ...
        if "led_tornado#on" in message:
            ...
            print("Démarrage de l'animation 'tornado_start'")
            ...
            self.set_color(self.ZONE_GLOBAL, *self.COLORS["purple"])
            self.send_message("mbianceManager=>[ambianceManager]=>tornado_rfid#end")
        elif message == "tornado_finished#true":
            print("Démarrage de l'animation 'tornado_finished'")
            ...
            print("Démarrage de l'animation 'tornado_to_crystal'")
