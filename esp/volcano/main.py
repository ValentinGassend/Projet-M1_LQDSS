...
class ESP32Controller:
    ...
    def process_websocket_message(self, message):
        ...
        if "led_volcano#on" in message:
            ...
            print("Démarrage de l'animation 'crystal_to_volcano'")
            ...
            print("Démarrage de l'animation 'volcano_start'")
            ...
            self.set_color(self.ZONE_GLOBAL, *self.COLORS["purple"])
            self.send_message("mbianceManager=>[ambianceManager]=>volcano_rfid#end")
        elif message == "volcano_finished#true":
            print("Démarrage de l'animation 'volcano_finished'")
            ...
            print("Démarrage de l'animation 'volcano_to_crystal'")
